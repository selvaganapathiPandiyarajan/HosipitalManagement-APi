package com.example.AdminDetail.Dto;
...
public class historyDto {
	...
	public historyDto(Integer historyId, String email, Integer age, Double temp, Double bP, Double weight,
			String symtoms, String percerption, String appointmentDate, String nextAppointmentDate, Integer doctorId,
			String doctorName, String doctorDesignation, String patientDetails, String icuNo) {
		super();
		this.historyId = historyId;
		this.email = email;
		this.age = age;
